...
export const env = {
  ...
  // Driver wallet
  DRIVER_MIN_WALLET_BALANCE: parseFloat(process.env.DRIVER_MIN_WALLET_BALANCE || '100'),

  // Ride matching radius in km
  DRIVER_SEARCH_RADIUS_KM: parseFloat(process.env.DRIVER_SEARCH_RADIUS_KM || '5'),
